...
class LiabilitiesProlongationOrder < StudentsOrder
	...
	def try_to_activate
		...
		if DetailsForLiabilitiesProlongationOrder.has_order?
			fixed_attrs = DetailsForLiabilitiesProlongationOrder.fix_order(self)
		...
		each_student :all, %w( student_id paragraph_id attributes ) do |student_id, paragraph_id, attributes|
			fixed_attrs = DetailsForLiabilitiesProlongationOrder.fix_student(self, student_id, paragraph_id, attributes)
