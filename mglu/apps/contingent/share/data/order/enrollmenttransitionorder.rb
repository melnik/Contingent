...
class EnrollmentTransitionOrder < VirtualStudentsOrder
	...
	AFFECTED_ATTRIBUTES = {
		:student => %w( degree_code student_state_id study_type_id first_name last_name father_name liabilities citizenship_id group_id card_number birth_date gender_id profession_code ),
	}
